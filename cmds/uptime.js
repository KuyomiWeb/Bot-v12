...
module.exports.run = async(bot, message, args) => {
    ...
    .setColor('#FF0000')
    .addField("**<:oui:763065449717563452> | Bot En Ligne Depuis...**", (Math.round(bot.uptime / (1000 * 60 * 60 * 24)) % 30) + " Jours, " + (Math.round(bot.uptime / (1000 * 60 * 60))) + " heures, " + (Math.round(bot.uptime / (1000 * 60)) % 60) + " Minutes, est " + (Math.round(bot.uptime / 1000) % 60) + " Secondes", true)
